      ...
      <div className="container-max section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-end mb-4">
              <div className="w-20 h-20 mb-2 mr-0">
                <img 
                  src="/images/logo.png" 
              ...
              <div>
                ...
                <p className="text-sm text-secondary-300">Professional Braiding</p>
              </div>
            </Link>
            <p className="text-secondary-300 mb-6">
              Serving Katy, Texas and surrounding areas with professional braiding services 
              that promote healthy hair growth and beautiful styles.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-secondary-300">Katy, Texas</span>
              </div>
              <div className="flex items-center space-x-3">
