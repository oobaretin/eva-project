            ...
            <div>
              ...
              <div className="space-y-4 text-secondary-600 leading-relaxed">
                <p>
                  ...
                  beauty industry began over 15 years ago when I discovered my passion for creating 
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-md p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-secondary-900 mb-3">15+ Years Experience</h3>
                <p className="text-secondary-600">
                  Over 15 years of professional braiding experience with thousands of satisfied clients.
                </p>
              </div>
