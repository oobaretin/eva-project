        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-secondary-500 mt-1">Mon-Sat: 9AM-7PM</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-secondary-600">Katy, Texas</p>
              ...
              {/* Social Media */}
              <div className="bg-white rounded-lg shadow-md p-8">
                <h2 className="text-2xl font-semibold text-secondary-900 mb-6">Follow Us</h2>
              ...
              {/* Quick Links */}
              <div className="bg-white rounded-lg shadow-md p-8">
                <h2 className="text-2xl font-semibold text-secondary-900 mb-6">Quick Links</h2>
                <div className="space-y-3">
                  ...
                  <a href="/reviews" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    ⭐ Read Client Reviews
                  </a>
                  <a href="/gallery" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    🖼️ View Our Gallery
                  </a>
                </div>
              </div>
          ...
          <div className="mt-12 bg-primary-50 border border-primary-200 rounded-lg p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-primary-900">Need Immediate Assistance?</h3>
                <p className="text-primary-700">
                  For urgent matters or same-day appointment changes, please call us directly at{' '}
                  <a href="tel:+18322079386" className="font-semibold underline">
                    (832) 207-9386
                  </a>
                </p>
              </div>
